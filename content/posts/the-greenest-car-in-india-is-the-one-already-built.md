...
summary: A large share of a car's carbon is locked in at manufacture, so keeping existing vehicles useful longer is the fastest realistic climate lever in Indian mobility. | Reuse only works when trust works, and used EVs show it sharpest: an opaque battery misprices the asset and punishes adoption exactly where it should compound. | The fix is standards and legibility, battery identity, portable warranties, fair tax and financing, not ad campaigns.
featured: false
category: Essay
...
- National Green Tribunal (2015) and Supreme Court of India (2018) orders deregistering ten-year diesel and fifteen-year petrol vehicles in Delhi-NCR. The age-based scrappage example.
- [Geotab, battery health study, January 2026](https://www.geotab.com/press-release/ev-battery-health-degradation-fast-charging-study/). 2.3% average annual degradation across 22,700+ EVs and 21 models; heat and high-power fast charging roughly double the rate.
- [TÜV SÜD](https://www.tuvsud.com/en-us/e-ssentials-newsletter/automotive-essentials/e-ssentials-01-2024/batteries-in-electric-cars--no-standard-for-battery-soh). No standardized method for battery state of health; methods diverge by up to ~7 percentage points.
- NITI Aayog EV supply-chain analysis. Battery pack at 35 to 40% of an EV's bill of materials.
- [ADB and NITI Aayog, EV financing report](https://www.niti.gov.in/sites/default/files/2023-07/ADB-EV-Financing-Report_VS_compressed.pdf). EV loans run 10 to 30% lower LTV and 6 to 18 months shorter tenor than petrol equivalents.
- GST Council, December 2024. 18% GST on the dealer margin for used EVs, against 5% on new EVs.
- [Office of the Principal Scientific Adviser, Government of India](https://psa.gov.in/CMS/web/sites/default/files/publication/Battery%20Pack%20Aadhaar%20Guideline.pdf). Draft guidelines for the Battery Pack Aadhaar (BPAN) system.
- EU Battery Regulation. Digital Battery Passport mandatory for EV batteries from 2027.
