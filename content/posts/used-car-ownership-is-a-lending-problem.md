...
date: 2026-06-12
description: India's pre-owned car market will not become mass only because used cars are cheaper than new ones. It becomes mass when lending can underwrite messy assets, lower upfront fear, and turn aspiration into manageable monthly ownership.
...
articleImageAlt: Editorial bridge visual for Used-Car Ownership Is a Lending Problem.
summary: Used cars improve affordability, but affordability is still theoretical if households must arrive with cash or badly priced credit. | A used-car lender is underwriting not only a borrower, but also the asset, the paperwork, and the recovery path. | Whoever builds better asset truth, pricing, transfer rails, and capital access will not just finance the used-car market. They will help create it.
featured: false
category: Essay
---
...
Pre-owned cars are the natural bridge into ownership in India because they sit where aspiration and budget can still meet. External market evidence points in the same direction. In July 2025, [Crisil Ratings](https://www.crisilratings.com/en/home/newsroom/press-releases/2025/07/used-car-volume-to-grow-8-10percent-over-twice-as-fast-as-new-one.html) said used-car volume in India was expected to cross `~6 million` units, with the used-to-new sales ratio improving to `~1.4x` from below `1.0x` five years earlier. Just as important, Crisil tied that structural shift not only to digital adoption and consumer confidence, but also to better access to finance and lender-platform underwriting improvements.
...
1. the borrower's ability and willingness to repay
2. the truth of the asset
3. the reliability of the process around ownership, transfer, and recovery
...
1. Better inspection, pricing, and documentation reduce uncertainty around the asset.
2. Lower uncertainty improves approvals and lowers losses.
3. Lower losses attract cheaper and larger pools of capital.
4. Better financing lowers the upfront cash barrier for buyers.
5. More financed buyers increase transaction liquidity and improve price discovery.
6. Better price discovery improves collateral confidence for the next loan.
